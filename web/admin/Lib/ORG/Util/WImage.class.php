 ...
 * 设置水印图片
 +-----------------------------------------------------------------
 * @param string $save_name		保存图片后的名字，默认为''，保存原名
 +-----------------------------------------------------------------
 ...
 */
	 ...
	 * 生成缩略图
	 +-----------------------------------------------------------------
	 * @param integer $w				宽，默认0
	 * @param integer $h				高，默认0
	 * @param integer $t				透明度，默认0
	 * @param string  $save_name		保存的名字
	 +-----------------------------------------------------------------
	 * @return boolean					成功返回true，失败返回false
	 +-----------------------------------------------------------------
	 */
 ...
 */
    ...
    function createimage($type, $img_name) {
 	 ...
 	 * @param integer $p_w			宽度
 	 * @param integer $p_h			高度
 	 +-----------------------------------------------------------------
 	 * @return array				返回x、y轴坐标
 	 +-----------------------------------------------------------------
 	 */
