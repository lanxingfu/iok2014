        ...
        if($this->thumb && in_array(strtolower($file['extension']),array('gif','jpg','jpeg','bmp','png'))) {
            ...
            if(false !== $image) {
                ...
                for($i=0;$i<$len; $i++) {
					...
					if($i==2){
						Image::water($filename.'.large.'.strtolower($file['extension']), './Public/images/shuiyin.png',null,100,true);
					}elseif($i==1){
						Image::water($filename.'.middle.'.strtolower($file['extension']), './Public/images/shuiy.png',null,100,true);
					}
                }
